...
<body>
    ...
    </nav>    <section class="items">
        <div class="container">
            <div class="border-red-wrapper mb-4">
                <h1 class="border-red">Жети Казына</h1>
            </div>
            <div class="row justify-content-center">
                <div class="img-wrapper" id="zhety">
                    <img src="img/zhetikazina.jpg" alt="">
                </div>
                <div class="default_content mx-auto w-75" itemprop="description">
                    ...
                    <div class="w-100">
                        <a href="#" class="btn btn-red ml-auto" data-toggle="modal" data-target="#callback">записаться</a>    
                        <a href="Jefood.php" class="btn btn-yellow ml-auto">назад</a>
                    </div>
                </div>
            </div>
        </div>
