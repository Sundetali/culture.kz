    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="container">
            ...
            <div class="row">
                        ...
                        <div class="item-box d-flex">
                            ...
                            <div class="items-right d-flex flex-column justify-content-between">
                                ...
                                <div class="item-bottom d-flex justify-content-between align-items-center flex-wrap"> 
                                    <a href="Dastur-more.php" class="btn btn-red">
                                        подробнее
                                    </a>
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                        <div class="item-box d-flex">
                            <img src="img/dastur2.jpg" alt="" height="172" width="172">
                            <div class="items-right d-flex flex-column justify-content-between">
                                <div class="info">
                                    <span>ававы аыв</span> 
                                    <span class="name">Кыз куу</span> 
                                    <span class="mw-100">Адрес: пр. Абылай хана 58 А</span>
                                </div>
                                <div class="item-bottom d-flex justify-content-between align-items-center flex-wrap"> 
                                    <a href="Dastur-more.php" class="btn btn-red">
                ...
                <div class="col-md-6">
                        <div class="item-box d-flex">
                            <img src="img/dastur3.jpg" alt="" height="172" width="172">
                            <div class="items-right d-flex flex-column justify-content-between">
                                <div class="info">
                                    <span>ававы аыв</span> 
                                    <span class="name">Байга</span> 
                                    <span class="mw-100">Адрес: пр. Абылай хана 58 А</span>
                                </div>
                                <div class="item-bottom d-flex justify-content-between align-items-center flex-wrap"> 
                                    <a href="Dastur-more.php" class="btn btn-red">
                ...
                <div class="col-md-6">
                        <div class="item-box d-flex">
                            <img src="img/yurt.png" alt="" height="172" width="172">
                            <div class="items-right d-flex flex-column justify-content-between">
                                <div class="info">
                                    <span>ававы аыв</span> 
                                    <span class="name">Алтыбакан</span> 
